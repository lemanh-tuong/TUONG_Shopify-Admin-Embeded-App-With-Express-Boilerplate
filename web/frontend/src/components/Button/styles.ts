...
export const container = (size: Size, borderWidth?: number) => {
  const sizeStyle = getSizeStyleMapping(borderWidth)[size];
  return css`
    ...
    padding: ${sizeStyle.paddingHorizontal}px ${sizeStyle.paddingVertical}px;
  `;
};
