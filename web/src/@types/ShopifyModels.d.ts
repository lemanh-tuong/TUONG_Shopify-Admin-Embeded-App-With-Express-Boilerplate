/**
 * CONVENTION: Yêu cầu 
    1. Đúng theo tài liệu của shopify
    2. Readonly ra readonly
    3. Kèm theo link docs với mỗi model
    4. Link tài liệu nó có 
 */

/** @description Định nghĩa type model của shopify */
declare global {
  declare namespace ShopifyModels {
